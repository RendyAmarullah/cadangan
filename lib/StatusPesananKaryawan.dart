    ...
    try {
      ...
      List<Map<String, dynamic>> acceptedOrders =
        ...
        return {
          ...
          'status': 'sedang diproses', // Status untuk pesanan yang diterima
          'isAccepted': true,
        };
      }).toList();
      ...
      List<Map<String, dynamic>> rejectedOrders =
        ...
        return {
          ...
          'alamat': doc.data['alamat'] ?? 'No Address',
          'createdAt': doc.data['createdAt'] ?? '',
          'status': 'ditolak', // Status untuk pesanan yang ditolak
          'isAccepted': false,
        };
      }).toList();

      // Gabungkan semua pesanan dan urutkan berdasarkan tanggal
